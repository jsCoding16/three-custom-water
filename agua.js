...
THREE.Water = function ( geometry, options ) {
	...
	var distortionScale = options.distortionScale !== undefined ? options.distortionScale : 1.0;
...
//agua
			...
			'	vec3 reflectionSample = vec3( texture2D( mirrorSampler, mirrorCoord.xy / (mirrorCoord.z + 1.2) + distortion ) );',
//vidro
           //'	vec3 reflectionSample = vec3( texture2D( mirrorSampler, mirrorCoord.xy / (mirrorCoord.z+1.0)) );',
...
THREE.Water.prototype.constructor = THREE.Vidro;
